...
%token ACC DIRTY NOT
/* NEW: ADDED FLUSH */
%token READ WRITE RMWREAD RMWWRITE FENCE FLUSH
...
va:
  /* NEW: Added bool for cacheability */
  LPAREN VA INT INT INT RPAREN {{PipeGraph.vtag=$3; PipeGraph.vindex=$4; PipeGraph.cacheability=$5}};
...
access:
  ...
  /* NEW ADDED FLUSH */
  | LPAREN FLUSH types va RPAREN {PipeGraph.FlushVA ($3, $4)};
