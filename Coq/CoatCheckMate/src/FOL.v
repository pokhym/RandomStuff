...
Definition EvaluatePredicate
  ...
  (* NEW: ISCACHEABLE pred *)
  | PredIsCacheable t =>
      match GetFOLTerm t l with
      | Some (MicroopTerm _ t1') =>
        if GetCacheability t1' then
          Some([], [])
        else
          None
      | _ => None
...
(* NEW: Added cahceability *)
Definition i0 := mkMicroop 0 0 0 0 (Write [] (VA 0 0 1) (PA (PTag 0) 0) (NormalData 1)).
Definition i1 := mkMicroop 1 0 0 0 (Write [] (VA 0 0 1) (PA (PTag 0) 0) (NormalData 1)).
Definition i2 := mkMicroop 2 0 0 0 (Read  [] (VA 0 0 1) (PA (PTag 0) 0) (NormalData 1)).
